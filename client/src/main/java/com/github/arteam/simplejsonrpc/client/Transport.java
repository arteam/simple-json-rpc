...
public interface Transport {
     ...
     *
     * @Param serviceName optional service name on which the method is referred
     ...
     */
    @NotNull String pass(@NotNull Optional<String> serviceName, @NotNull String request) throws IOException;
}
